                ...
                <div className="bg-white p-10 rounded-4xl text-neutral-600 flex flex-col gap-3 border-2 border-neutral-100 mb-14 md:mb-0 min-h-105 duration-200 ease-in justify-center">
                    ...
                    <div className={`${tokenValido ? 'block' : 'hidden'}`}>
                        ...
                        <div className={`${passwordValidationFlag ? 'h-61' : 'h-22'} flex flex-col gap-1 duration-200 ease-in overflow-hidden px-1`}>
                            ...
                            />
                            <div className="absolute hover:bg-neutral-200 cursor-pointer p-1 rounded-lg duration-200 ease-in mt-10 ml-64 sm:ml-96" 
                            onClick={() => {
                        ...
                        <div className="flex flex-col gap-1 px-1">
                            ...
                            />
                            <div className="absolute hover:bg-neutral-200 cursor-pointer p-1 rounded-lg duration-200 ease-in mt-10 ml-64 sm:ml-96" onClick={() => {setShowConfirmPassword(!showConfirmPassword)}}>
                                {showConfirmPassword ? 
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fillRule="currentColor" className="size-5">
                                <path d="M3.53 2.47a.75.75 0 0 0-1.06 1.06l18 18a.75.75 0 1 0 1.06-1.06l-18-18ZM22.676 12.553a11.249 11.249 0 0 1-2.631 4.31l-3.099-3.099a5.25 5.25 0 0 0-6.71-6.71L7.759 4.577a11.217 11.217 0 0 1 4.242-.827c4.97 0 9.185 3.223 10.675 7.69.12.362.12.752 0 1.113Z" />
                                <path d="M15.75 12c0 .18-.013.357-.037.53l-4.244-4.243A3.75 3.75 0 0 1 15.75 12ZM12.53 15.713l-4.243-4.244a3.75 3.75 0 0 0 4.244 4.243Z" />
